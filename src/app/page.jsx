...
const projects = [
  {
    ...
    description: 'A professionalwebsite for an optician serving the metropolitan area since 2010. ',
  ...
  {
    name: 'DogFoster',
    description:'Connecting pups with foster homes and forever families one pup at a time. Tranport provided.',
