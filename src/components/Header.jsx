...
function ResumeIcon(props) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path d="M7 4V3h10v1h2v18H5V4h2zm4 14h2v-2h-2v2zm0-4h2v-2h-2v2zm0-4h2V8h-2v2z" />
    </svg>
  )
}
